...
class Model:
    ...
    def add_second_stage_constraints(self):
        ...
        # second stage constraints on time horizon
    ...
    def optimize(self, t_decision, t_end, predictions_PV, predictions_load, forecasting = True, objective_1 = 'cost', objective_2 = 'soc',
                 method = 'deterministic', parameters = None, lambda_soc = 0.5, verbose = True):
        ...
        # SOC objective
        SOC_difference =  gp.quicksum([self.SOC_max - self.SOC[self.t_end,i] for i in self.range_samples])
    ...
    def update_decisions(self):
        '''update decision variables at time of decision + resulting SOC at time of forecast'''
    ...
    def predictions_SOC(self):
        '''SOC predictions (for intermediate results)'''
    ...
    def results_deterministic(self):
        '''get decisions when deterministic (if intermediate results)'''
    ...
    def results_stochastic(self):
        '''get decisions when stochastic (if intermediate results)'''
